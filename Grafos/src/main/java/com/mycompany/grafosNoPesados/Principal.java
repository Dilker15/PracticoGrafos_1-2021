...
public class Principal {
     ...
     */
    public static void main(String[] args) throws ExcepcionesGrafos, ExcepcionAristaYaExiste, ExceptionesNroVerticeInvalidos, ExceptionAristaYaExiste, ExceptionAristaNoExiste {
